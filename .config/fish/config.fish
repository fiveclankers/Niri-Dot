...
if status is-interactive
    # 1. Run fastfetch with the small logo so it doesn't break in Niri tiles
    fastfetch 

    # 2. Initialize the Starship prompt (this fixes your barebones shell)
...
# opencode
fish_add_path /home/cat/.opencode/bin
